...
import { X, Loader2, AlertCircle, FileText, Check, CreditCard, Smartphone } from 'lucide-react';
                ...
                <>
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full bg-red-600 text-white py-2.5 rounded-lg font-bold hover:bg-red-700 flex items-center justify-center gap-2 text-sm"
                    >
                      <FileText size={18} />
