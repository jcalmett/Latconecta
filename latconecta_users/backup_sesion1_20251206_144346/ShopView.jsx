...
const handleBuyClick = () => {
  ...
  purchase_currency: selectedProduct.product_currency || 'PEN',
  ...
  purchase_delivery_name: purchaseData.deliveryName || (user?.user_name) || 'Cliente Anónimo',  // ✅ Modificado
  ...
  // ✅ NUEVO: purchase_user_id nullable
  purchase_user_id: user?.user_id || null,
  
  // ✅ MODIFICADO: created_by
  created_by: user?.user_email || 'anonymous',
      ...
      // Construir resultado UI - CORRECCIÓN: Barcode Pending también es exitoso
      ...
      const uiResult = {
        ...
        // ✅ CORREGIDO: Ajustar a hora de Lima (UTC-5)
        ...
        // Datos reales del pago para mostrar
...
╚═══════════════════════════════════╝
  ...
  // POPUP: Flujo de Compra (ahora como componente separado)
...
{/* ✅ CORREGIDO: Tabs de Servicios - Solo servicios activos */}
