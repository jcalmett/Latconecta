...
class VendorAPIMapper:
    ...
    def __init__(self, mapping_config: Dict[str, Any]):
        ...
        self.request_mapping = mapping_config.get('request_mapping', {})
        self.value_transformations = mapping_config.get('value_transformations', {})
    ...
    def _apply_transformations(
        ...
        """
        if field_name not in self.value_transformations:
            return value
    ...
    def parse_response(self, vendor_response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        response_mapping = self.mapping_config.get('response_mapping', {})
        parsed = {}
    ...
    def is_success_response(
        ...
        """
        success_config = self.mapping_config.get('success_indicators', {})
